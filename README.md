[![Build Status](https://travis-ci.org/makuro/swagger-node.svg?branch=master)](https://travis-ci.org/makuro/swagger-node) 
[![npm version](https://badge.fury.io/js/swagger-node-bi.svg)](https://badge.fury.io/js/swagger-node-bi)
[![Dependency Status](https://david-dm.org/makuro/swagger-node/status.svg)](https://david-dm.org/makuro/swagger-node)
[![devDependency Status](https://david-dm.org/makuro/swagger-node/dev-status.svg)](https://david-dm.org/makuro/swagger-node#info=devDependencies)
